...
$$\epsilon_{1M}=\frac{\%\Delta Q_X}{\%\Delta X}, $$
...
##<span style="color:SaddleBrown">Classifications Based on Magnitude of Demand Elasticities (See Table 1 of *An Interactive Text*)</span>
...
##<span style="color:SaddleBrown">Own-price Elasticities Show the Responsiveness of Quantity to Changes to Price (Demonstration 1 from *An Interactive Text*)</span>
```{r, echo=FALSE}
shinyApp(
  ui = fluidPage(
    sidebarPanel(
...
##<span style="color:SaddleBrown">The Relationship Between Price Changes, Own-Price Elasticity, and Revenue (Demonstration 2 from *An Interactive Text*)</span>
```{r, echo=FALSE}
require(shiny)
...
2. The second number you need is the value of the demand variable in question.  In this case, $P_1$.  

3. The third and final number you need is the value of $Q_1$.


##<span style="color:SaddleBrown">Point Formulas for Other Elasticities are Computed Similarly (Table 2 of *An Interactive Text*)</span>
...
##<span style="color:SaddleBrown">Point Elasticities at These Two Data Points (Table 3 of *An Interactive Text*)</span>
...
2. There is a point where demand will be unitary elastic
3. Demand will be less elastic at lower prices

* However this is not true for all demand equations.  Some specifications of demand provide constant elasticities. 

##Demonstration 3.  Own-Price Elasticity Will Vary Along a Linear Demand Curve (Demonstration 3 of *An Interactive Text*)</span>
...
##<span style="color:SaddleBrown">The Arc Formula for Elasticities (Table 4 of *An Interactive Text*)</span>
...
##<span style="color:SaddleBrown">The Habit Parameter Affects the Time to Converge to a New Long-Run Demand Schedule (Demonstration 4 from *An Interactive Text*)</span>
```{r, echo=FALSE}
require(shiny)
...
##<span style="color:SaddleBrown">Convergence to Long-Run Demand Over Time (Demonstration 5 from *An Interactive Text*)</span>
...
##<span style="color:SaddleBrown">Demand at Different Stages of the Market (Figure 1 of *An Interactive Text*)</span>
...
##<span style="color:SaddleBrown">Supply Elasticities are Computed Similarly to Demand Elasticities (Table 6 of *An Interactive Text*)</span>
...
##<span style="color:SaddleBrown">Classifications Based on Magnitude of Elasticity of Supply (Table 5 of *An Interactive Text*)</span>
