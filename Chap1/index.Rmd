...
Th learning objectives for this chapter are as follows.
...
With latent demand, one does not actually see market transactions.  For this reason, estimating the potential value of products in a latent demand state is often more difficult.  

A change in technology, such as the introduction of the microwave oven, can unleash a number of new products that address latent demands and thereby bring them into a state of effective demand.  The first link below points to an early television commercial for the microwave.  This commercial speaks directly to how the microwave meets the latent demands of those who prepare meals over the eons of human history.  Today, much of what is in the frozen section of a supermarket is tailored to the microwave oven. The challenge, of course, is coming up with the right new product.  The second link points to an early concept for microwave popcorn.  How did this concept miss the mark?

* Early microwave oven commercial showing how the microwave addresses latent demand [(visit  youtube.com)](https://www.youtube.com/watch?v=IKQzieCJqBA).

* Early concept for microwave popcorn [(visit youtube.com)](https://www.youtube.com/watch?v=VffEa74oDuE).
...
* National Geographic segment on edible insects [(visit youtube.com)](https://www.youtube.com/watch?v=oQBVW9APQik).

* Fact sheet on entomophagy from the UN Food and Agriculture Organization [(visit fao.org)](http://www.fao.org/docrep/018/i3264e/i3264e00.pdf).


###Food Irradiation:  A Case Example

Food irradiation is a process that could potentially address latent demands.  In the late 1990's, irradiation was approved for use on raw meat and poultry.  There were some predictions that this would become a standard process, akin to pasteurization.  This turned out not to be the case.  One reason is that irradiated foods also face a negative demand problem.  Consumers have been hesitant to embrace irradiated foods.  Review the fact sheet and short video clip from the links below.

* Fact sheet from the University of Wisconsin on food irradiation [(visit wisc.edu)](https://uw-food-irradiation.engr.wisc.edu/Facts.html).  

* A Stossel in the Classroom segment on food irradiation, its uses, and its acceptance [(visit youtube.com)](https://www.youtube.com/watch?v=087JTrlRUfk).  

Now consider the following questions:

1. What fundamental problem (or problems) can food irradiation address?

2. Is food irradiation safe?  What entities support its use?

3. Are there labeling requirements that would allow you tell if a food item in a retail store was irradiated?  

4. Is food irradiation used widely today?  Why not?  
...
Demand is subject to trends, fashions, health concerns, and a variety of other considerations.  For example, in 2012, media coverage of lean finely textured beef (LFTB), also known as "pink slime", had an impact on demand for ground beef.  This would classify as information that led to an unfavorable change in preferences (meaning the product in question is less favored by consumers than before).  Conversely, a growing number of studies linking blueberries to improved health has impacted demand for blueberries in a positive way.  This would classify as a favorable change in preferences.   

* Link to a 2012 magazine article on the LFTB controversy by economists J. Ross Pruitt and David P. Anderson [(visit choicesmagazine.org)](http://www.choicesmagazine.org/UserFiles/file/cmsarticle_268.pdf).

* Link to the 2012 ABC News Segment on LFTB mentioned in the magazine article [(visit youtube.com)](https://www.youtube.com/watch?v=87uBMXdIyjo).

* Link to LSU AgCenter publication *Blueberries and Your Health*  [(visit lsuagcenter.com)](http://www.lsuagcenter.com/~/media/system/b/d/9/1/bd91d79e86236b7d4b9253a28d832d41/pub3267blueberriesandyourhealth.pdf).
