...
shinyApp(
  ...
  server = function(input,output) {
    ...
    output$Quest<-renderUI({paste("What will happen to profit above AVC if you raise your price by ",probDat[input$prob,"DP"],"dollars?")})
    ...
    output$Answer3<-renderUI({
      if(!input$show) return()
      paste("Profit over AVC will go",probDat[input$prob,"Direct"],"to",probDat[input$prob,"NewProf"],"dollars.")
    })
  }
)
```
