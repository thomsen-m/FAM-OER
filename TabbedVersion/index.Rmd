...
Should you wish to adopt this text in your class, please download the source files from the [GitHub](https://github.com/thomsen-m/FAM-OER) repository and deploy them on a server. The version you are seeing now is for demonstration purposes, and the hosting platform is not likely to meet the demands of your class. Alternatively your students can access *An Interactive Text* locally on their own machines through an R installation with the "shiny" and "rmarkdown" packages installed. In addition to the source files for the text itself, the [GitHub](https://github.com/thomsen-m/FAM-OER) repository provides R Markdown files that render to html slide sets.  These can be used or modified to support lectures based on this text.
